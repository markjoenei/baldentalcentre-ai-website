export const teamMembers = [
  {
    name: "Dr. Tanya Khattra",
    role: "General Dentist",
    bio: "Dr. Tanya brings a calm, modern approach to family and cosmetic dentistry — known for her gentle chair-side manner and meticulous attention to detail.",
    image: "/images-about/team/dr-tanya-khattra.jpg",
    credentials: ["D.D.S.", "RCDSO Licensed", "ODA Active Member"],
  },
  {
    name: "Dr. Amol Karande",
    role: "Associate Dentist",
    bio: "Dr. Amol focuses on comprehensive general and restorative dentistry, helping patients of every age feel relaxed and informed at every visit.",
    image: "/images-about/team/dr-amol-karande.jpg",
    credentials: ["General Dentistry", "RCDSO Licensed", "ODA Active Member"],
  },
  {
    name: "Dr. Mufakkhar Sultana",
    role: "General Dentist",
    bio: "Dr. Sultana delivers thoughtful, evidence-based care across cleanings, fillings, crowns and family dentistry — explaining every option in plain English.",
    image: "/images-about/team/dr-mufakkhar-sultana.jpg",
    credentials: ["General Dentistry", "RCDSO Licensed", "ODA Active Member"],
  },
  {
    name: "Dr. Lovepreet Kaur",
    role: "General Dentist",
    bio: "Dr. Kaur is passionate about preventive care and patient education, ensuring every smile she treats leaves the chair healthier than it arrived.",
    image: "/images-about/team/dr-lovepreet-kaur.jpg",
    credentials: ["General Dentistry", "RCDSO Licensed", "ODA Active Member"],
  },
  {
    name: "Dr. Shamal Kulkarni",
    role: "General Dentist",
    bio: "Dr. Kulkarni provides full-scope general dentistry with a warm, family-first philosophy that puts even the most anxious patients at ease.",
    image: "/images-about/team/dr-shamal-kulkarni.jpg",
    credentials: ["General Dentistry", "RCDSO Licensed", "ODA Active Member"],
  },
  {
    name: "Dr. Dhifaf Al Shakarchi",
    role: "General Dentist",
    bio: "Dr. Al Shakarchi blends technical precision with a multilingual, culturally-aware approach to care — a true favourite among our diverse Scarborough patients.",
    image: "/images-about/team/dr-dhifaf-al-shakarchi.jpg",
    credentials: ["General Dentistry", "RCDSO Licensed", "Multilingual"],
  },
];
...
export const teamLeadBio = {
  ...
  image: "/images-about/team/dr-gus-bal.png",
  bio: [
    "Dr. Gus Bal founded Bal Dental Centre with a simple mission: deliver world-class dentistry in a neighbourhood setting. Over two decades later, that mission still drives every cleaning, crown, and smile makeover.",
    "Dr. Bal has trained extensively in general, cosmetic and restorative dentistry, and is an active member of the Royal College of Dental Surgeons of Ontario and the Ontario Dental Association. He has assembled a multilingual, multi-specialty clinical team that mirrors the diversity of Scarborough itself.",
    "Outside the clinic, you'll find him supporting local community health initiatives, mentoring younger associates, and championing accessible care for every family in the GTA.",
  ],
  stats: [
