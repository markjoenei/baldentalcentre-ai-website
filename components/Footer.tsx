          ...
          <div>
            ...
            <div className="mt-8 flex items-center gap-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="group flex h-10 w-10 items-center justify-center rounded-xl border border-gold/20 bg-white/[0.04] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#ff0000] hover:bg-[#ff0000]"
              >
                <svg viewBox="0 0 576 512" className="h-4 w-4 fill-gold transition-colors group-hover:fill-white" aria-hidden="true">
